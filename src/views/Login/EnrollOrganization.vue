  ...
  <div class="enrollOrganizationWrapper">
    <h2 class="header">账号信息</h2>
      <div class="accountNumberInfo">
        <el-form :model="orgForm" status-icon :rules="rules" ref="orgForm" label-width="140px" class="demo-ruleForm " >
          <el-form-item label="组织管理员账号" prop="org_user_name" hide-required-asterisk="true"> 
            <el-input v-model="orgForm.org_user_name"></el-input>
          </el-form-item>
          <el-form-item label="组织管理员密码" prop="org_password" hide-required-asterisk="true">
            <el-input type="password" v-model="orgForm.org_password" autocomplete="off"></el-input>
          </el-form-item>
        </el-form>
      </div>
      ...
      <div class="userInfo">
      <el-form :model="orgForm" status-icon :rules="rules" ref="orgForm" label-width="140px" class="demo-ruleForm " >
        <el-form-item label="组织机构名称" prop="org_name" hide-required-asterisk="true">
          <el-input v-model="orgForm.org_name"></el-input>
        </el-form-item>
        <el-form-item label="组织联系人" prop="org_representative" hide-required-asterisk="true">
          <el-input v-model="orgForm.org_representative"></el-input>
        </el-form-item>
        <el-form-item label="组织联系人手机号" prop="org_phone" hide-required-asterisk="true">
          <el-input v-model="orgForm.org_phone"></el-input>
        </el-form-item>
        <el-form-item label="组织地址" prop="org_address" hide-required-asterisk="true">
          <el-cascader
            size="large"
            :options="options"
        ...
        <el-form-item label="组织头像" prop="org_pic" hide-required-asterisk="true">
    ...
    <h2 class="header">注册信息</h2>
      <el-button type="danger" class="btn01"  @click="EnrollOrganization('orgForm')">申请实名注册组织机构队伍</el-button>
    <div class="step" >
      ...
      orgForm: {
        ...
        rules: {
          ...
          org_representative: [
            ...
            { min: 2, max: 10, message: '请输入正确的联系人姓名', trigger: 'blur' }
          ],
          org_address: [
          ...
          org_desc: [
            ...
            { min: 10, max: 200, message: '组织描述长度为 10 到200 个字符', trigger: 'blur' }
          ],
