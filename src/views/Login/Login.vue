      ...
      <div class="info">
        <el-tabs v-model="activeName"  stretch type="border-card">
          <el-tab-pane label="志愿者登录" name="first">
            ...
            <el-form ref="volform" status-icon :model="volunteerForm" :rules="rules" label-width="80px" class="formWrapper">

              <el-form-item label="用户名" prop="user_name">
                <el-input v-model="volunteerForm.user_name" placeholder="请输入志愿者用户名"></el-input>
              </el-form-item>

              <el-form-item label="密码" prop="password">
                <el-input type="password" v-model="volunteerForm.password"  placeholder="请输入密码"></el-input>
              </el-form-item>
              <el-form-item label="验证码" prop="verificationCode">
                <el-input v-model="volunteerForm.verificationCode" autocomplete="off"></el-input>
              ...
              <el-form-item>
                <el-button type="primary" @click="volLogin('volform')">登录</el-button>
                
              </el-form-item>
              <el-form-item>
                <el-link @click="openEnrol">注册账号<i class="el-icon-view el-icon--right"></i> </el-link>
              </el-form-item>
            </el-form>
          </el-tab-pane>
          ...
          <el-tab-pane label="组织机构登录" name="second">
            <el-divider></el-divider>
            <el-form ref="orgform" :model="orgForm" :rules="rules" label-width="80px" class="formWrapper">
              <el-form-item label="用户名" prop="org_user_name">
                <el-input v-model="orgForm.org_user_name" placeholder="请输入组织管理员用户名"></el-input>
              </el-form-item>

              <el-form-item label="密码" prop="org_password">
                <el-input type="password" v-model="orgForm.org_password"  placeholder="请输入密码"></el-input>
              </el-form-item>
              <el-form-item class="lastItem">

                <el-button type="primary" @click="orgLogin('orgform')">登录</el-button>
              </el-form-item>
              <el-form-item >
                <el-link @click="openEnrol">注册账号<i class="el-icon-view el-icon--right"></i> </el-link>
              </el-form-item>
        ...
        this.$refs[formName].validate((valid) => {
          if (valid) {
            ...
            this.axios({
              ...
              url:'/user/login',
              data:JSON.stringify({
                user_name:this.volunteerForm.user_name,
                password:this.volunteerForm.password
              })
            }).then(res => {
              console.log(res);
              if(res.status == 200 && res.data.data.res_status.code == 10000){
