        ...
        <el-header style="text-align: right; font-size: 14px">
          ...
          <el-dropdown trigger="click">
            ...
            <el-dropdown-menu slot="dropdown">
                ...
                <el-dropdown-item icon="el-icon-circle-plus" @click.native="unloginVol">个人退出登录</el-dropdown-item>
                <el-dropdown-item icon="el-icon-circle-plus-outline" @click.native="unloginOrg">组织退出登录</el-dropdown-item>
            </el-dropdown-menu>
            </el-dropdown>
        </el-header>
        <div class="flec">
            <el-menu default-active="1" :default-openeds="['1','2', '3','4']" class="el-menu-vertical-demo menuWrapper"  :collapse="isCollapse">
            ...
            <el-submenu index="2">
                ...
                <el-menu-item-group>
                <el-menu-item index="2-1" @click="goUserList">个人用户</el-menu-item>
                </el-menu-item-group>
                <el-menu-item-group>
